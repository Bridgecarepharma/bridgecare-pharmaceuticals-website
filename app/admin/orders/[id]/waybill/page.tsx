...
export default async function WaybillPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <main className="waybill-screen">
    ...
    <article className="waybill-label">
      ...
      <div className="waybill-handle-care" role="note" aria-label="Handle with care">
        HANDLE WITH CARE
      </div>
    ...
    <style>{`
      ...
      .waybill-footer{padding-top:3mm;border-top:2px solid #173f58}.waybill-footer>div{display:grid;gap:.5mm}.waybill-footer strong{font-size:9pt}.waybill-footer span{font-size:7.4pt;line-height:1.25;color:#536b79}.waybill-handle-care{margin-top:2mm;padding:1.8mm 2mm;border:2px solid #071b2b;text-align:center;font-size:13pt;font-weight:900;letter-spacing:.08em;line-height:1;color:#071b2b}.waybill-barcode{padding-top:3mm;text-align:center;color:#071b2b}.waybill-barcode svg{display:block;width:100%;height:13mm}.waybill-barcode strong{display:block;margin-top:1mm;font-size:8pt;letter-spacing:.08em}
      ...
      @media print{
        html,body{width:100mm!important;height:150mm!important;min-height:150mm!important;margin:0!important;padding:0!important;overflow:hidden!important;background:#fff!important}
        .site-header,.footer,.floating-contact,.cart-drawer-layer,.no-print,iframe,[id^="tawk"],[class*="tawk"]{display:none!important}
        .waybill-screen{position:relative!important;width:100mm!important;height:150mm!important;min-height:150mm!important;margin:0!important;padding:0!important;overflow:hidden!important;background:#fff!important;z-index:2147483647!important}
        .waybill-label{position:relative!important;box-sizing:border-box!important;width:100mm!important;height:150mm!important;min-height:150mm!important;max-height:150mm!important;margin:0!important;border:0!important;box-shadow:none!important;padding:3.5mm 5mm 25mm!important;overflow:hidden!important;display:flex!important;flex-direction:column!important;-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important;break-inside:avoid!important;page-break-inside:avoid!important}
        ...
        .waybill-items{padding:1.7mm 0!important;flex:0 1 auto!important;min-height:0!important}.waybill-section-head{margin-bottom:.5mm!important}.waybill-section-head>strong{font-size:7pt!important;padding:.6mm 1.5mm!important}.waybill-item{padding:.8mm 0!important;font-size:7.7pt!important;line-height:1.05!important}.waybill-item strong{font-size:8pt!important}
        ...
        .waybill-handle-care{position:absolute!important;left:5mm!important;right:5mm!important;bottom:13mm!important;margin:0!important;padding:1.5mm 1mm!important;border:2px solid #071b2b!important;text-align:center!important;font-size:11pt!important;font-weight:900!important;letter-spacing:.08em!important;line-height:1!important;break-inside:avoid!important;page-break-inside:avoid!important}
