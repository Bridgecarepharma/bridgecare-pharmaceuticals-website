...
export default async function WaybillPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <main className="waybill-screen">
    ...
    <style>{`
      ...
      @media print{
        html,body{width:100mm!important;min-height:200mm!important;height:auto!important;margin:0!important;padding:0!important;overflow:hidden!important;background:#fff!important}
        .site-header,.footer,.floating-contact,.cart-drawer-layer,.no-print,iframe,[id^="tawk"],[class*="tawk"]{display:none!important}
        .waybill-screen{position:relative!important;width:100mm!important;height:auto!important;min-height:200mm!important;margin:0!important;padding:0!important;overflow:hidden!important;background:#fff!important;z-index:2147483647!important}
        .waybill-label{box-sizing:border-box!important;width:100mm!important;height:auto!important;min-height:200mm!important;max-height:none!important;margin:0!important;border:0!important;box-shadow:none!important;padding:5mm 6mm!important;overflow:visible!important;-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important}
        /* Keep the printout complete: use a taller thermal page and never clip the footer/barcode. */
        .waybill-header{gap:5mm!important;padding-bottom:2.5mm!important}
        .waybill-logo{width:43mm!important}
        .waybill-title strong{font-size:15pt!important}.waybill-title span{font-size:8pt!important}
        .waybill-order-row{padding:2.5mm 0!important;gap:2mm!important}
        .waybill-recipient{padding:3mm 0!important}.waybill-recipient h1{margin-top:1mm!important;font-size:17pt!important}.waybill-recipient>a{margin-top:1mm!important;font-size:14pt!important}.waybill-recipient>p{margin-top:1mm!important;font-size:9.5pt!important;line-height:1.2!important}.waybill-callout{padding:1mm 2mm!important;font-size:8pt!important}
        .waybill-items{padding:2.5mm 0!important;flex:0 1 auto!important;min-height:0!important}.waybill-section-head{margin-bottom:1mm!important}.waybill-item{padding:1.2mm 0!important;font-size:9pt!important}.waybill-item strong{font-size:9.5pt!important}
        .waybill-footer{margin-top:auto!important;padding-top:2mm!important;flex:0 0 auto!important}.waybill-footer>div{gap:.25mm!important}.waybill-footer strong{font-size:8.5pt!important}.waybill-footer span{font-size:6.8pt!important;line-height:1.12!important}
        .waybill-barcode{padding-top:1.5mm!important;flex:0 0 13mm!important;height:13mm!important;overflow:hidden!important}.waybill-barcode svg{height:9mm!important}.waybill-barcode strong{margin-top:.5mm!important;font-size:7pt!important}
      }
    `}</style>
  </main>;
}
