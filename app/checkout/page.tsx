...
import { formatNaira,shippingFeeForState } from "@/lib/store";
...
export default function CheckoutPage(){
 ...
 <h2>Delivery method</h2><label className="radio-card"><input type="radio" name="deliveryMethod" value="standard" checked={deliveryMethod==="standard"} onChange={()=>setDeliveryMethod("standard")}/><span><strong>Standard delivery</strong><small>{formatNaira(shippingFeeForState(state))}</small></span></label>
