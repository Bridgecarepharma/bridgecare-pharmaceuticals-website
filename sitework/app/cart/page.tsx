...
export default function CartPage(){
 ...
 <aside className="order-summary"><h2>Order summary</h2><div><span>Subtotal</span><strong>{formatNaira(subtotalKobo)}</strong></div><p>Delivery is calculated from the state and delivery method entered at checkout.</p><Link className="button full" href="/checkout">Continue to checkout</Link></aside></div>}
 </div></section></>
}
